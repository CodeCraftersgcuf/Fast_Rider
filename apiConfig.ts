...
const API_ENDPOINTS = {
  AUTH: {
    Login: API_DOMAIN + "/auth/rider/login",
    Register: API_DOMAIN + "/auth/rider/register",
    Logout: API_DOMAIN + "/auth/logout",
    VerfiyEmailOtp: API_DOMAIN + "/auth/rider/otp-verification",
    ResendOtp: API_DOMAIN + "/auth/rider/resend-otp",
    ForgotPassword: API_DOMAIN + "/auth/rider/forget-password",
    VerifyPasswordOtp: API_DOMAIN + "/auth/rider/verify-forget-password-otp",
    ResetPassword: API_DOMAIN + "/auth/rider/reset-password",
    VerificationStep1: API_DOMAIN + "/auth/rider/verification/step-1",
    VerificationStep2: API_DOMAIN + "/auth/rider/verification/step-2",
